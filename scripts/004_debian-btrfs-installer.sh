...
#      - Guardar como: E:\scripts\004_debian-btrfs-installer.sh
...
#
#   8. Ejecutar:
#      chmod +x 004_debian-btrfs-installer.sh
#      sudo ./004_debian-btrfs-installer.sh
#
...
#    mv installer.sh 004_debian-btrfs-installer.sh
#
# 3. Ejecutar:
#    chmod +x 004_debian-btrfs-installer.sh
#    sudo ./004_debian-btrfs-installer.sh
