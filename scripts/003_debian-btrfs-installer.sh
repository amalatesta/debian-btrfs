...
#   - Instala con tasksel: SSH server + standard system utilities
#
...
#
# Software adicional:
#   - Se instala automáticamente con tasksel:
...
#   Este script instala de forma no interactiva y consistente:
#   * standard
#   * ssh-server
#   para replicar el flujo del instalador oficial cuando marcás esas opciones.
#
# ============================================
# CÓMO EJECUTAR
# ============================================
...
#      - Guardar como: E:\scripts\003_debian-btrfs-installer.sh
...
#
#   8. Ejecutar:
#      chmod +x 003_debian-btrfs-installer.sh
#      sudo ./003_debian-btrfs-installer.sh
#
...
#    mv installer.sh 003_debian-btrfs-installer.sh
#
# 3. Ejecutar:
#    chmod +x 003_debian-btrfs-installer.sh
#    sudo ./003_debian-btrfs-installer.sh
...
show_configuration_summary() {
    ...
    echo "  ✓ btrfs-progs"
    echo "  ✓ tasksel automático: standard + SSH"
    echo ""
...
install_software() {
    ...
    separator
    echo ""
    echo "Se instalarán automáticamente con tasksel:"
    echo "  - SSH server"
